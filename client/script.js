...
//             newElement.textContent = res.data[i].value;
...
// const rptBtn = document.querySelector("#repeat-button");
...
// CODE HERE
// const sendQuery = () => {
//     axios.get('http://localhost:3000/query-test?name=carter')
//     .then(res => {
//         console.log(res.data);
//     })
//     .catch(error => {
...
// document.querySelector("#query-button").addEventListener("click", sendQuery);
...
/*
    ...
    // The console gives you a message that says no queries were sent. 

    2: Send more than 1 query on the URL -- what happened? 
    //You sent more than one query and it rreturns both.
*/

// Edit code in Problem 8

const sendQuery = () => {
    axios.get('http://localhost:3000/query-test?name=carter&last=walsh')
    .then(res => {
        console.log(res.data);
    })
    .catch(error => {
...
const createFood = (event) => {
    ...
    let foodInput = document.querySelector("#text");
